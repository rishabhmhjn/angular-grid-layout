...
import { getMutableClientRect, _ClientRect } from './client-rect';
 ...
 */
function getVerticalScrollDirection(clientRect: _ClientRect, pointerY: number) {
 ...
 */
function getHorizontalScrollDirection(clientRect: _ClientRect, pointerX: number) {
...
export function ktdScrollIfNearElementClientRect$(scrollableParent: HTMLElement | Document, options?: KtdScrollIfNearElementOptions): (source$: Observable<{ pointerX: number, pointerY: number }>) => Observable<any> {
    ...
    let scrollableParentClientRect: _ClientRect;
...
function getViewportRect(): _ClientRect {
